...
/* harmony import */ var react_stripe_checkout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("r0Hv");
...
const OrderShow = ({
  ...
  const {
    doRequest,
    errors
  } = Object(_hooks_use_request__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])({
    url: '/api/payments',
    method: 'post',
    body: {
      orderId: order.id
    },
    onSuccess: payment => next_router__WEBPACK_IMPORTED_MODULE_1___default.a.push('/orders')
  });
  ...
  return __jsx("div", null, __jsx("h1", null, "Order Details"), __jsx("h3", null, "Time left to pay: ", timeLeft, " seconds"), __jsx(react_stripe_checkout__WEBPACK_IMPORTED_MODULE_2___default.a, {
    token: ({
      id
    }) => doRequest({
      token: id
...
/* harmony default export */ __webpack_exports__["a"] = (({
  ...
  const doRequest = async (props = {}) => {
    try {
      setErrors(null);
      const response = await axios__WEBPACK_IMPORTED_MODULE_1___default.a[method](url, _objectSpread({}, body, {}, props), body);
